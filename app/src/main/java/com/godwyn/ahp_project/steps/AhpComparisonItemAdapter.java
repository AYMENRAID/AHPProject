...
import com.godwyn.ahp_project.domain.entity.ComparisonItem;
import com.godwyn.ahp_project.domain.enums.ComparisonDefinitionEnum;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class AhpComparisonItemAdapter extends RecyclerView.Adapter<AhpComparisonItemAdapter.ItemViewHolder> {
    ...
    public AhpComparisonItemAdapter(List<ComparisonItem> mComparisonItems, Context mContext, ItemViewHolder mViewHolder, ComparisonItem mComparisonItem, int itemPosition) {
        this.mComparisonItems = mComparisonItems;
        this.mContext = mContext;
        this.mViewHolder = mViewHolder;
        this.mComparisonItem = mComparisonItem;
...
//            mDashboardViewContract.showProblemIdentifiedDetail(ComparisonItem);
        ...
        mViewHolder.mAhpMethodComparisonItemBinding.ahpMethodCriterionOneStepFirstSeekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
